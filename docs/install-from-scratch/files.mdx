...
curl -Lo panel.tar.gz https://github.com/Jexactyl/Jexactyl/releases/download/v4.0.0-beta2/panel.tar.gz
...
After downloading the Jexactyl's files, we need to set the proper permissions so the webserver can access the files.
