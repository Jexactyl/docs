...
If you require a different guide, please refer to [Pterodactyl](https://pterodactyl.io/panel/1.0/webserver_configuration.html).
:::
...
If you encounter any issues, please let us know on our [Discord](https://jexactyl.xyz/discord).
:::
