...
# Upgrade Jexpanel version

This guide is for upgrading the Panel to a new version.

:::danger
This will NOT work if you are trying to migrate from Pterodactyl, or Jexpanel `v3.x`. This is only for
...
curl -Lo panel.tar.gz https://github.com/Jexpanel/Jexpanel/releases/download/v4.0.0-beta5/panel.tar.gz
