---
title: 'Jexpanel v4 - A new chapter'
authors: [camwhi-te]
date: '2024-12-31'
tags: ['hello']
---
...
## Introduction
Since 2022, Jexpanel v3 has provided a smooth, hyperfast UI and reliable backend to tens of thousands of users and business owners.
...
Jexpanel v4 includes a brand new, state-of-the-art billing suite using Stripe and PayPal as payment gateways.
This allows businesses to collect payments with ease, and see all details in the Stripe dashboard as well as Jexpanel.
...
Having this advanced payment system in Jexpanel offers several benefits:
...
Jexpanel v4 includes a new system which logs all activity made by all administrators on the Panel
...
Jexpanel v4 expands on v3's design modularity by allowing admins to create their own colour palettes directly in the panel UI,
...
While it's a simple feature, having a central place for important links improves customer experience. Jexpanel's links system
...
Jexpanel v4 includes an Alerts system, which can be enabled to notify users of important information.
...
This list of new features and customization options are just the start of Jexpanel v4's list of new
